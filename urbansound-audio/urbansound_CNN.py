...
from keras.layers import Dense, Dropout, Activation, Convolution2D, Conv2D, MaxPooling2D, GlobalAveragePooling2D
...
# split the dataset 
x_train, x_test, y_train, y_test = train_test_split(X, yy, test_size=0.2, random_state = params['random_state'])
...
# Fit model
model.fit(x_train, y_train, batch_size=params['batch_size'], epochs=params['epochs'], validation_data=(x_test, y_test), verbose=1)
